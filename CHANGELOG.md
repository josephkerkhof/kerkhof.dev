...
- Update content on the "now" page
...
- Favicon and Apple touch icon, set from the Berkeley Mono Bold `k` outline.
...
- Added a Now page for current work, interests, and priorities.

### Changed

- Replaced Contact with Now in the primary navigation and moved Contact to the footer.

## [1.0.10] - 2026-08-27

### Added

- Added the Sonic waiting animation to the Slack reaction collection.
...
- Improved SQL syntax highlighting for qualified column references.
...
[Unreleased]: https://github.com/josephkerkhof/kerkhof.dev/compare/v1.0.22...HEAD
